...
export default function Home() {
  ...
  return (
    <Fragment>
      ...
      <nav className="navbar navbar-expand-md py-1" style={{backgroundColor: "#fff7f8", width: "inherit", height: "inherit"}}>
              ...
              <div className="row">
                <div className="col-sm-6 py-5 ps-2 ">
                  ...
                  <div style={{display: "inline-flex"}}>
                    ...
                    <div className="ps-5">
                      <button className="btn text-white btn-lg text-nowrap py-3 input-border" style={{backgroundColor: "#ff5c3f"}}>
                          Search
                      </button>
                    </div>
